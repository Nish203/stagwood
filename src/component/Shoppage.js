  ...
  return (
    <div>
        ...
        <div className='container sm:grid grid-cols-4 gap-3 pb-16  '>
            <div className=' md:self-start sticky top-0  col-span-1 bg-white px-4 pb-6 rounded shadow overflow-hidden '>
...
{/* Color */}
                    <div className='py-4'> 
                        ...
                        <div className='space-y-2 space-x-2'>
                            <div className='flex items-center'>
                                <input type="checkbox" id="cat-1" className='ml-2 text-primary focus:ring-0 rounded-sm cursor-pointer'/>  
                                <label for='color-red' className='border border-gray-200 rounded-sm h-4 w-4 cursor-pointer shadow-sm block bg-black ml-3' ></label>
                                <label for="cat-1" className='text-gray-600 ml-2 cursol-pointer '>Sal wood</label>
                               
                            </div>

                            <div className='flex items-center'>
                                <input type="checkbox" id="cat-1" className='text-primary focus:ring-0 rounded-sm cursor-pointer'/> 
                                <label for='color-red' className='border border-gray-200 rounded-sm h-4 w-4 cursor-pointer shadow-sm block bg-gray-600 ml-3' ></label> 
                                <label for="cat-1" className='text-gray-600 ml-3 cursol-pointer'>Indian Rosewood</label>
                            ...
                            <div className='flex items-center'>
                                <input type="checkbox" id="cat-1" className='text-primary focus:ring-0 rounded-sm cursor-pointer'/>  
                                <label for='color-red' className='border border-gray-200 rounded-sm h-4 w-4 cursor-pointer shadow-sm block bg-orange-500 ml-3' ></label>
                                <label for="cat-1" className='text-gray-600 ml-3 cursol-pointer'>Oak Wood</label>
                            ...
                            <div className='flex items-center'>
                                <input type="checkbox" id="cat-1" className='text-primary focus:ring-0 rounded-sm cursor-pointer'/>  
                                <label for='color-red' className='border border-gray-200 rounded-sm h-4 w-4 cursor-pointer shadow-sm block bg-orange-800 ml-3' ></label>
                                <label for="cat-1" className='text-gray-600 ml-3 cursol-pointer'>Mulberry Wood</label>
